...
setwd("/home//mdbrown/nethome/Yingye/Packages/survMarkerTwoPhase/")
...
for( i in 1:NSim){
  index = index + 1; 
#simulate cohorts with 70% censoring, 5000 individuals
